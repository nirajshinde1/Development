...
int main()
{
	...
	cout<<"-------------------------------------\n";
	cout<<"After Insert N and S struct nodes at Last:\n";
	obj.InsertLast('N');
	obj.InsertLast('S');
	obj.Display();
	...
	cout<<"-------------------------------------\n";
	cout<<"After Insert V at second Position:\n";
	obj.InsertAtPos('V',2);
	obj.Display();
	...
	cout<<"-------------------------------------\n";
	cout<<"After Insert 25 at second Position:\n";
	obj1.InsertAtPos(25,2);
	obj1.Display();
